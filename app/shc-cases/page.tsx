...
//   const loadAllCases = async (isNewSearch = false) => {
//     if (isNewSearch) {
//       setIsSearching(true);
//       setAllCases([]);
//       setFilteredCases([]);
...
//             <p className="mt-4 text-gray-600">Loading initial cases...</p>
//           </div>
//         )}
  ...
  return (
    <div>
      ...
      <div className="container mx-auto p-6">
        ...
        {/* Main Search Form (API Call) */}
        {/* <div className="md:flex md:gap-4 lg:flex lg:gap-4 justify-center items-center mb-6">
          <div>
            <label
            ...
            <select
              ...
              disabled={!allDataLoaded || isSearching}
            >
